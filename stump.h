...
void train_adaboost_stump(const struct problem_class* prob_cls, const struct adaboost_stump_parameter* param, struct stump*** const stump_bag_ret, int* const bag_size_ret) {
